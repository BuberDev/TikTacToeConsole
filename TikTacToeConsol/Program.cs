        ...
        class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                do
                {
                    ...
                    {
                        if ((playField[0, 0] == playerChar) && (playField[1, 0] == playerChar) && (playField[2, 0] == playerChar)
                    ...
                    do
                    {
                        Console.Write("\n Player {0}: Choose your field, please:   ", player);
                        try
                        {
                        ...
                        {
                            Console.WriteLine("\n Incorrect input. Please use other field");
                            inputCorrect = false;
                        }
